...
export default function VideoPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-black to-purple-900 min-h-screen text-white px-4 py-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-5 animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          {!playVideo ? (
            <div
              className="relative cursor-pointer group mb-6 overflow-hidden rounded-3xl shadow-2xl"
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-gradient-to-r from-purple-500/80 to-pink-500/80 backdrop-blur-sm rounded-full p-8 transform scale-75 group-hover:scale-100 transition-all duration-300 shadow-2xl">
                  <svg
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                <div className="absolute w-40 h-40 border-4 border-white/10 rounded-full animate-ping delay-1000"></div>
              </div>
            </div>
          ) : (
            <div className="relative group mb-6 overflow-hidden rounded-3xl shadow-2xl">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl p-6 rounded-2xl border border-gray-700/50 shadow-xl">
              ...
              {/* Channel Info */}
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-800/50 to-gray-700/50 backdrop-blur-sm rounded-xl border border-gray-600/30">
              ...
              {/* Description */}
              <div className="mt-6 p-4 bg-gradient-to-r from-gray-800/30 to-gray-700/30 backdrop-blur-sm rounded-xl border border-gray-600/30">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl p-6 rounded-2xl border border-gray-700/50 shadow-xl sticky top-6">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-6 flex items-center">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <textarea
                      ...
                      className="w-full bg-gray-800/50 border-2 border-gray-600/50 px-4 py-3 rounded-xl focus:outline-none focus:border-purple-500 focus:bg-gray-800 transition-all duration-300 resize-none placeholder-gray-400"
                      rows={3}
                    />
                    <button
                      className="group relative mt-3 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-xl font-semibold transition-all duration-300 hover:scale-105"
                      onClick={addComment}
                    >
                      <span className="flex items-center">
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto custom-scrollbar">
                {comments.length === 0 ? (
                  ...
                  comments.map((comment, index) => (
                    <div
                      key={index}
                      className="group relative bg-gradient-to-r from-gray-800/30 to-gray-700/30 backdrop-blur-sm p-4 rounded-xl border border-gray-600/30 hover:border-purple-500/30 transition-all duration-300"
                      style={{
                    ...
                    >
                      <div className="flex gap-3">
                        ...
                        />
                        <div className="flex-1">
                          <div className="font-semibold text-sm text-purple-300">{comment.userName || "Anonymous"}</div>
                          <div className="text-gray-300 text-sm mt-1 leading-relaxed">{comment.content}</div>
                        </div>
                      </div>
                    </div>
                  ))
