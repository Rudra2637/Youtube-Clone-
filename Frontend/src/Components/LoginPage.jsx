      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <button
              type="submit"
              className="group relative w-full py-4 bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 hover:from-green-500 hover:via-blue-500 hover:to-purple-500 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/50 transform"
            >
