...
function Home() {
  ...
  useEffect(() => {
    ...
    checkUser(); // ← Don't forget to call it!
  }, [dispatch]);
  ...
  // Example placeholder video data
  ...
  return (
    <div className="min-h-screen bg-black text-white px-6 py-4">
      <h1 className="text-3xl font-bold mb-6 text-white">🔥 Trending Videos</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {videos.map((video) => (
          <div key={video.id} className="bg-zinc-900 rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300">
